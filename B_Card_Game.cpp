...
void solve() {
    ...
    for (const auto& currentCase : cases) {
        ...
        if (currentCase[0][0] > currentCase[1][0]) {
            firstCount++;
            chk=0;
        } else if (currentCase[0][0] < currentCase[1][0]) {
            secondCount++;
            chk=1;
        }
        chk=0;
        
        if (currentCase[0][1] > currentCase[1][1]) {
            firstCount++;
        } else if (currentCase[0][1] < currentCase[1][1]) {
            secondCount++;
            chk=0;
        }
        
        if(firstCount > secondCount && !chk)  total++;
    }
