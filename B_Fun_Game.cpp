...
//   string str1 = to_string(s1), str2= to_string(s2);

//   ll onn = count(all(str1), '1');
//   ll zer = count(all(str1), '0');
//   ll onn1 = count(all(str2), '1');
//   ll zer1 = count(all(str2), '0');

//   if(onn <= onn1) print("YES")
//   else print("NO")

  print(((str1.find('1')<= str2.find('1')) ? "YES"  : "NO" ));
