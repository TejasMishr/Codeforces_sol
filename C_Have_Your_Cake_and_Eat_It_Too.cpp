...
bool sol(vll& a, vll& b, vll& c, ll tot) {
    res[0] = 1;
    int n = a.size();
    ll th = (tot + 2) / 3; 
...
void sol() {
    ...
    REP(i,0,6){
        ...
        switch(i) {
            case 0: chk = sol(vec1, vec2, vec3, tot); break;
            case 1: chk = sol(vec1, vec3, vec2, tot); break;
            case 2: chk = sol(vec2, vec1, vec3, tot); break;
            case 3: chk = sol(vec2, vec3, vec1, tot); break;
            case 4: chk = sol(vec3, vec1, vec2, tot); break;
            case 5: chk = sol(vec3, vec2, vec1, tot); break;
        }
        if (chk) {
            res[5] = n;
            switch(i) {
                case 0: cout << res[0] << " " << res[1] << " " << res[2] << " " << res[3] << " " << res[4] << " " << res[5] << endl; break;
                case 1: cout << res[0] << " " << res[1] << " " << res[4] << " " << res[5] << " " << res[2] << " " << res[3] << endl; break;
                case 2: cout << res[2] << " " << res[3] << " " << res[0] << " " << res[1] << " " << res[4] << " " << res[5] << endl; break;
                case 3: cout << res[4] << " " << res[5] << " " << res[0] << " " << res[1] << " " << res[2] << " " << res[3] << endl; break;
                case 4: cout << res[2] << " " << res[3] << " " << res[4] << " " << res[5] << " " << res[0] << " " << res[1] << endl; break;
                case 5: cout << res[4] << " " << res[5] << " " << res[2] << " " << res[3] << " " << res[0] << " " << res[1] << endl; break;
            }
            return;
        }
    }
